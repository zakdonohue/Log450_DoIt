...
class ManageFriendsScreen extends StatefulWidget {
  ...
  @override
  ManageFriendsScreenState createState() => ManageFriendsScreenState();
}

class ManageFriendsScreenState extends State<ManageFriendsScreen> {
      ...
      if (userResponse.statusCode == 200) {
        ...
        for (var friendId in friendIds) {
          final friendResponse =
              await http.get(Uri.parse('http://10.0.2.2:3000/users/$friendId'));
  ...
  Future<void> _deleteFriend(String friendId) async {
    try {
      final usersResponse = await http.delete(
          Uri.parse('http://10.0.2.2:3000/users/$userId/friends/$friendId'));
